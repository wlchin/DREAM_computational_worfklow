...
p <- cimDiablo(final.diablo.model, comp = 1, trim = 6, 
               color.Y = c("red", "blue"),
...
Heatmap(mat, name = "Correlation", 
        ...
        top_annotation = annotation_col, column_km = 2, row_km = 2,
        row_names_gp = grid::gpar(fontsize = 2), show_parent_dend_line = FALSE,
        column_names_gp = grid::gpar(fontsize = 2), border = TRUE, clustering_method_rows = "complete", 
        clustering_method_columns = "single", clustering_distance_rows = "pearson",
